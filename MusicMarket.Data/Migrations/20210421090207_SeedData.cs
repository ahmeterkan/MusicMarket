...
namespace MusicMarket.Data.Migrations
{
    public partial class SeedData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("INSERT INTO Musics (Name, ArtistId) Values ('The Trooper', (SELECT Id FROM Artists WHERE Name = 'Flogging Molly'))");
            ...
            migrationBuilder.Sql("INSERT INTO Musics (Name, ArtistId) Values ('Californication', (SELECT Id FROM Artists WHERE Name = 'Red Hot Chili Peppers'))");
            migrationBuilder.Sql("INSERT INTO Musics (Name, ArtistId) Values ('Tell Me Baby', (SELECT Id FROM Artists WHERE Name = 'Red Hot Chili Peppers'))");
            migrationBuilder.Sql("INSERT INTO Musics (Name, ArtistId) Values ('Parallel Universe', (SELECT Id FROM Artists WHERE Name = 'Red Hot Chili Peppers'))");
